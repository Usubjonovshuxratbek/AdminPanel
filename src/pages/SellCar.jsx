        ...
        <div className="offer__wrapper">
          ...
          <div className="offer__item">
              <div className="box__01">
                <h3 className='client__name'>Kilian James</h3>
              ...
              <div className="box__03">
                <span className='model__spend-icon'><i className='ri-car-line'></i></span>
                <h6 className='spend__amount'>$1174</h6>
                <p className='spend__title'>Model Spend</p>
              </div>

              <div className="box__04">
                <span className='model__spend-icon'><i className='ri-share-forward-line'></i></span>
                <h6 className='spend__amount'>$1174</h6>
                <p className='spend__title'>Model Spend</p>
              </div>

              <div className="box__05">
                <span className='model__spend-icon'><i className='ri-money-dollar-circle-line'></i></span>
            ...
            <div className="offer__item">
              <div className="box__01">
                <h3 className='client__name'>Jhone Doe</h3>
